...
public class MergeKSortedLists {
	...
	/*
	 * Time complexity # Since we’ll be going through all the elements of all
	 * arrays and will be removing/adding one element to the heap in each step,
	 ...
	 * time, our min-heap will be storing one number from all the ‘K’ input
	 * arrays.
	 */
