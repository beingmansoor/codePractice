...
/*
 * 
 * There are N buckets numbered 1 through N. The buckets contain balls; each ball has a color between 1 and K. Let's denote the number of balls with color j that are initially in bucket i by ai,j.
