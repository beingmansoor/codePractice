...
public class SortStack {
	...
	public static void sortStackUsingTempStack(Stack<Integer> stack) {
		...
		// 3. If the value is greater or equal to the top of tempStack, then
		// push the value in tempStack
		// else pop all values from tempStack and push them in mainStack and in
		// the end push value in tempStack and repeat from step 2.
		// till mainStack is not empty.
		// 4. When mainStack will be empty, tempStack will have sorted values in
		// descending order.
		// 5. Now transfer values from tempStack to mainStack to make values
