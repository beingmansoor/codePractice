...
public class LetterCaseStringPermutation {
	...
	/*
	 * Problem Statement # Given a string, find all of its permutations
	 * preserving the character sequence but changing case.
	 * 
	 * Example 1:	
	 * Input: "ad52" Output: "ad52", "Ad52", "aD52", "AD52" 
	 * Example 2: 
	 * Input: "ab7c" Output: "ab7c", "Ab7c", "aB7c", "AB7c", "ab7C", "Ab7C",
	 * "aB7C", "AB7C"
	 */
	public static List<String> findLetterCaseStringPermutations(String str) {
		...
		for (int i = 0; i < str.length(); i++) {
			if (Character.isLetter(str.charAt(i))) { // only process characters,
														// skip digits
				...
				for (int j = 0; j < n; j++) {
					...
					// if the current character is in upper case change it to
