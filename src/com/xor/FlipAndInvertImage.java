...
public class FlipAndInvertImage {
	 ...
	 * reversed. For example, flipping [0, 1, 1] horizontally results in [1, 1,
	 * 0].
	 * 
	 ...
	 * Example 1:
	 * 
	 * Input: [ [1,0,1], [1,1,1], [0,1,1] ] Output: [ [0,1,0], [0,0,0], [0,0,1]
	 ...
	 * 
	 * Solution Flip: We can flip the image in place by replacing ith element
	 * from left with the ith element from the right.
	 * 
	 * Invert: We can take XOR of each element with 1. If it is 1 then it will
	 * become 0 and if it is 0 then it will become 1.
	 */
