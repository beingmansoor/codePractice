...
public class CalculateComplement {
	 ...
	 * 
	 * number ^ number ^ complement = number ^ all_bits_set From the
	 * above-mentioned second property:
	 * 
	...
	public static int bitwiseComplement(int num) {
		...
		// For example, '4' which is a complete power of '2', and '3' (which is
		// one less than 4) has a binary
