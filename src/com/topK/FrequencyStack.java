...
class ElementComparator implements Comparator<Element> {
	public int compare(Element e1, Element e2) {
		...
		// if both elements have same frequency, return the one that was pushed
		// later
...
public class FrequencyStack {
	...
	/*
	 * Time complexity # The time complexity of push() and pop() is
	 * O(logN) where ‘N’ is the current number of elements in the heap.
	 * 
	 * Space complexity # We will need O(N) space for the heap and the map,
