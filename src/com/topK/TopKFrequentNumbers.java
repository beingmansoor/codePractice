...
public class TopKFrequentNumbers {
	...
	public static List<Integer> findTopKFrequentNumbers(int[] nums, int k) {
		...
		// top k frequent numbers. If the heap size is more than k, we remove
		// the smallest (top) number
	 ...
	 * O(N+N*logK).
	 * 
	 * Space complexity # The space complexity will be O(N). Even though we
	 * are storing only ‘K’ numbers in the heap. For the frequency map, however,
