...
public class SearchInfiniteSortedArray {
	 ...
	 * the index of the ‘key’ if it is present in the array, otherwise return
	 * -1.
	 * 
	 ...
	 * the array. ArrayReader.get(index) will return the number at index; if the
	 ...
	 * Output: -1 Explanation: The key is not present in the array. Example 3:
	 * 
	 * Input: [1, 3, 8, 10, 15], key = 15 Output: 4 Explanation: The key is
	 * present at index '4' in the array. Example 4:
	 * 
	 * Input: [1, 3, 8, 10, 15], key = 200 Output: -1 Explanation: The key is
