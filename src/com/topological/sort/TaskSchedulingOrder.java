...
public class TaskSchedulingOrder {
  public static List<Integer> findOrder(int tasks, int[][] prerequisites) {
	 ...
	 * ‘0’ to ‘N-1’. Each course has some prerequisite courses which need to be
	 * completed before it can be taken. Given the number of courses and a list
	 * of prerequisite pairs, write a method to find the best ordering of the
