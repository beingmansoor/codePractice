...
public class TaskScheduling {
  public static boolean isSchedulingPossible(int tasks, int[][] prerequisites) {
	 ...
	 * and each edge (prerequisite) will be accessed and removed once.
	 * Therefore, the time complexity of the above algorithm will be
	 * O(V+E), where ‘V’ is the total number of tasks and ‘E’ is the total
	 ...
	 * 
	 * Similar Problems # Course Schedule: There are ‘N’ courses, labeled from
	 * ‘0’ to ‘N-1’. Each course can have some prerequisite courses which need
	 * to be completed before it can be taken. Given the number of courses and a
	 * list of prerequisite pairs, find if it is possible for a student to take
	 * all the courses.
	 * 
	 * Solution: This problem is exactly similar to our parent problem. In this
	 * problem, we have courses instead of tasks.
	 */
