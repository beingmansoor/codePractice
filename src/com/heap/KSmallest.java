...
public class KSmallest {
	...
	/*
	 * Time Complexity # The time complexity of creating a heap is O(n), as
	 * discussed before. And for removing min is O(klogn). So the total
	 * time complexity is O(nlogn) since k≤n.
	 */
