...
public class TokenBucketFilter1 {

    private int MAX_TOKENS;
    private long lastRequestTime = System.currentTimeMillis();
    long possibleTokens = 0;

    public TokenBucketFilter1(int maxTokens) {
    ...
    public static void runTestMaxTokenIs1() throws InterruptedException {
        ...
        final TokenBucketFilter1 tokenBucketFilter = new TokenBucketFilter1(1);
    ...
    public static void main( String args[] ) throws InterruptedException {
        TokenBucketFilter1.runTestMaxTokenIs1();
    }
}
